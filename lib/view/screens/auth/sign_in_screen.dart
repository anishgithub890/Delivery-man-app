...
import 'package:the_best_food/view/base/custom_text_field.dart';
import 'package:the_best_food/view/screens/auth/widget/code_picker_widget.dart';
...
class SignInScreen extends StatelessWidget {
              ...
              child: SizedBox(
                ...
                child: GetBuilder<AuthController>(builder: (authController) {
                  ...
                  return Column(children: [
                    ...
                    Image.asset(Images.logo_name, width: 250),
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        ...
                        */
                        AppTextField(hintText:"phone".tr, textController:_phoneController, icon:Icons.phone),
                        SizedBox(height: 10,),
                        AppTextField(obscureText:true,hintText:"password".tr, textController:_passwordController, icon:Icons.password_sharp),
                       /* CustomTextField(
                    ...
                    !authController.isLoading ?GestureDetector(
                      onTap: (){
                        _login(authController, _phoneController, _passwordController, context);
                      },
                      child: Container(
  ...
  void _login(AuthController authController, TextEditingController phoneCtlr, TextEditingController passCtlr, BuildContext context) async {
      ...
      authController.login(_phone, _password).then((status) async {
        if (status.isSuccess) {
          if (authController.isActiveRememberMe) {
            authController.saveUserNumberAndPassword(_phone, _password, "00");
          } else {
