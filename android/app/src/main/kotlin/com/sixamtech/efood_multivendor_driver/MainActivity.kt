package com.dbestech.the_best_food
...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(binaryMessenger, "com.dbestech/background_service").apply {
        ...
        MethodChannel(binaryMessenger, "com.dbestech/app_retain").apply {
            setMethodCallHandler { method, result ->
